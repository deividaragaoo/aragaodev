          ...
          <div className="relative px-5 py-12 sm:px-16 sm:py-24 lg:py-28 text-center">
            ...
            <div className="mx-auto flex w-full max-w-md flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:justify-center">
              ...
              <motion.a
                ...
                whileHover={{ y: -1 }}
                whileTap={{ scale: 0.98 }}
                className="inline-flex w-full sm:w-auto min-h-[52px] items-center justify-center gap-2 rounded-full border border-border bg-transparent px-7 py-3.5 text-sm font-medium text-foreground transition-all duration-200 hover:border-foreground/20 hover:bg-foreground/[0.04] active:scale-[0.98] sm:text-base"
              >
